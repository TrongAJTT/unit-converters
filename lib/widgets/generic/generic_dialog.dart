...
import 'package:unit_converters/utils/widget_layout_render_helper.dart';
...
class GenericDialogHeader extends StatelessWidget {
  ...
  const GenericDialogHeader({
    ...
    this.headerTextColor,
         ...
         customExitIcon == null || displayExitButton,
...
class GenericDialogFooter extends StatelessWidget {
  ...
  factory GenericDialogFooter.twoSimpleButtons({
    ...
    return GenericDialogFooter.twoCustomButtons(
      context: context,
      leftButton: TextButton(onPressed: onLeft, child: Text(leftText)),
...
class GenericDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveDecorator =
        decorator ??
        GenericDialogDecorator(width: DynamicDimension.flexibilityMax(90, 600));
        ...
        child: ClipRRect(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                padding:
                    effectiveDecorator.headerPadding ??
                    const EdgeInsets.fromLTRB(24, 24, 12, 12),
                color:
                    effectiveDecorator.headerBackColor ??
              ...
              Flexible(
                child: Container(
                  padding:
                      effectiveDecorator.bodyPadding ??
                      const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
                  color:
                      effectiveDecorator.bodyBackColor ??
                      Theme.of(context).colorScheme.surface,
                  child: body,
                ),
              ),
              ...
              Container(
                padding:
                    effectiveDecorator.footerPadding ??
                    const EdgeInsets.fromLTRB(24, 12, 24, 24),
                color:
                    effectiveDecorator.footerBackColor ??
                    Theme.of(context).colorScheme.surface,
                child: footer,
              ),
            ],
