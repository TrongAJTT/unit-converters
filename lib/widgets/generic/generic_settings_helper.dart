...
import 'package:unit_converters/widgets/generic/generic_settings_dialog.dart';
import 'package:unit_converters/widgets/generic/generic_settings_screen.dart';
      ...
      builder: (context) => Container(
        ...
        child: Column(
          children: [
            ...
            // Settings content
            Expanded(child: config.settingsLayout),
          ],
        ),
      ),
    );
