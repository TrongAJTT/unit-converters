...
class StepItem {
  ...
  StepItem({required this.step, required this.description});
}
...
class GenericInfoDialog extends StatelessWidget {
  ...
  static Widget buildFeatureItem(ThemeData theme, FeatureItem feature) {
    return Padding(
  ...
  static Widget buildStepItem(ThemeData theme, StepItem stepItem) {
    return Padding(
      padding: const EdgeInsets.all(8),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
