...
/// Service for managing volume converter state, cache, and presets using unified data structure
class VolumeUnifiedService {
  static const String _toolCode = 'volume';
  static const _uuid = Uuid();

  // ===== STATE MANAGEMENT =====

  /// Load volume converter states
  static Future<List<Map<String, dynamic>>> loadState() async {
    try {
      ...
      developer.log('VolumeUnifiedService: Failed to load state: $e');
      return [];
    }
  }

  /// Save volume converter states
  static Future<void> saveState(List<Map<String, dynamic>> states) async {
    try {
      ...
      developer.log('VolumeUnifiedService: Saved ${states.length} states');
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to save state: $e');
      rethrow;
    }
  }

  /// Clear volume converter states
  static Future<void> clearState() async {
    try {
      await ConverterToolsDataService.clearStates(_toolCode);
      developer.log('VolumeUnifiedService: Cleared states');
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to clear state: $e');
      rethrow;
    }
  }
  ...
  static Future<List<Map<String, dynamic>>> loadPresets() async {
    try {
      ...
      developer.log('VolumeUnifiedService: Failed to load presets: $e');
      return [];
    }
  }
  ...
  static Future<String> savePreset({
    ...
    try {
      ...
      developer.log('VolumeUnifiedService: Saved preset: $name');
      return id;
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to save preset: $e');
      rethrow;
    }
  }
  ...
  static Future<Map<String, dynamic>?> getPreset(String id) async {
    try {
      ...
      developer.log('VolumeUnifiedService: Failed to get preset: $e');
      return null;
    }
  }
  ...
  static Future<void> deletePreset(String id) async {
    try {
      ...
      developer.log('VolumeUnifiedService: Deleted preset $id');
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to delete preset: $e');
      rethrow;
    }
  }
  ...
  static Future<void> updatePreset(
    ...
    try {
      ...
      developer.log('VolumeUnifiedService: Updated preset $id');
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to update preset: $e');
      rethrow;
    }
  }
  ...
  static Future<void> renamePreset(String id, String newName) async {
    try {
      ...
      developer.log('VolumeUnifiedService: Renamed preset $id to $newName');
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to rename preset: $e');
      rethrow;
    }
  }
  ...
  static Future<bool> presetNameExists(String name) async {
    try {
      ...
      developer.log('VolumeUnifiedService: Failed to check preset name: $e');
      return false;
    }
  }
  ...
  static Future<void> clearAllPresets() async {
    try {
      ...
      developer.log('VolumeUnifiedService: Cleared all presets');
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to clear presets: $e');
      rethrow;
    }
  }
  ...
  static Future<List<Map<String, dynamic>>> exportPresets() async {
    try {
      ...
      developer.log('VolumeUnifiedService: Failed to export presets: $e');
      return [];
    }
  }
  ...
  /// Get all volume data (state + presets)
  static Future<Map<String, dynamic>> getAllData() async {
    try {
      ...
      developer.log('VolumeUnifiedService: Failed to get all data: $e');
      return {
  ...
  static Future<void> clearAllData() async {
    try {
      ...
      developer.log('VolumeUnifiedService: Cleared all volume data');
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to clear all data: $e');
      rethrow;
    }
  }

  /// Check if volume state exists
  static Future<bool> hasState() async {
    try {
      final state = await loadState();
      return state.isNotEmpty;
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to check state: $e');
      return false;
    }
  }

  /// Get volume state size
  static Future<int> getStateSize() async {
    try {
      final state = await loadState();
      return state.toString().length;
    } catch (e) {
      developer.log('VolumeUnifiedService: Failed to get state size: $e');
      return 0;
    }
  }
}
