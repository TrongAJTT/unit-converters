...
/// Service for managing weight converter state, cache, and presets using unified data structure
class WeightUnifiedService {
  static const String _toolCode = 'weight';
  static const _uuid = Uuid();

  // ===== STATE MANAGEMENT =====

  /// Load weight converter states
