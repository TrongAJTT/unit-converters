...
/// Service for managing area converter state, cache, and presets using unified data structure
class AreaUnifiedService {
  static const String _toolCode = 'area';
  static const _uuid = Uuid();

  // ===== STATE MANAGEMENT =====

  /// Load area converter states
