...
/// Service for managing temperature converter state, cache, and presets using unified data structure
class TemperatureUnifiedService {
  static const String _toolCode = 'temperature';
  static const _uuid = Uuid();

  // ===== STATE MANAGEMENT =====

  /// Load temperature converter states
  ...
  /// Save temperature converter states
  ...
  /// Clear temperature converter states
  ...
  /// Check if temperature state exists
