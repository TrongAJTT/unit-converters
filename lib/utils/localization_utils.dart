...
import 'package:unit_converters/utils/date_utils.dart';
...
class LocalizationUtils {
    ...
    switch (formatType) {
      case DateTimeFormatType.full:
        final DateFormat formatter = DateFormat.yMd(
          locale,
        ).add_jms(); // Date and time
        return formatter.format(dateTime);
      case DateTimeFormatType.exceptSec:
        final DateFormat formatter = DateFormat.yMd(
          locale,
        ).add_jm(); // Date and time without seconds
        return formatter.format(dateTime);
  ...
  static String getLocalizedWeekdayName(
    ...
    final day = weekday is int
        ? weekday
        : int.tryParse(weekday.toString()) ?? 1;
    switch (day) {
      case 1:
        return l10n.monday;
      case 2:
