...
import 'dart:convert';
import 'package:unit_converters/models/donor_model.dart';
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ElevatedButton(onPressed: _loadDonors, child: Text(_loc.retry)),
          ],
        ),
      );
    }
      ...
      builder: (context) => AlertDialog(
        ...
        content: ConstrainedBox(
          ...
          child: SingleChildScrollView(
            child: Text(donor.comment, style: theme.textTheme.bodyMedium),
          ),
        ),
        actions: [
          TextButton(
