...
import 'package:unit_converters/models/author_product_model.dart';
...
class AuthorProductsLayout extends StatefulWidget {
  ...
  const AuthorProductsLayout({super.key, this.showTitle = true, this.padding});
  ...
  Widget _buildEmptyState(ThemeData theme) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.apps_outlined, size: 64, color: theme.colorScheme.outline),
          const SizedBox(height: 16),
          Text(
